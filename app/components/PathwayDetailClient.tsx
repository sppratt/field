          ...
          <>
            ...
            <section style={{ marginBottom: 'var(--spacing-2xl)' }}>
              ...
              {!simulationState.completed && currentStepData ? (
                <div className={styles.simulationContainer}>
                  <p style={{ fontSize: 'var(--font-size-base)', color: 'var(--color-text-light)', marginBottom: 'var(--spacing-lg)', fontStyle: 'italic' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)' }}>
                    {currentStepData.choices.map((choice) => (
                      <button
                        ...
                        onMouseEnter={(e) => {
                          if (!isSaving) (e.target as HTMLButtonElement).style.backgroundColor = 'rgba(168, 184, 160, 0.1)';
                        }}
                        onMouseLeave={(e) => {
